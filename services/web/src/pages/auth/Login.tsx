...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Redirect by role
      if (data.role === 'worker') window.location.href = '/worker/home';
      else if (data.role === 'manager') window.location.href = '/manager/schedule';
      else if (data.role === 'admin') window.location.href = '/manager/users';
    } catch (err: any) {
